...
export class AuthModule extends BaseModule {
   ...
   * @returns 登录响应
   */
  public async login(usernameOrEmail: string, password: string, rememberMe = false): Promise<LoginResponse> {
   ...
   * @returns 用户信息
   */
  public async register(params: RegisterParams): Promise<UserInfo> {
    return this.post<UserInfo>('/register', params);
  }
  ...
  public async refreshToken(refreshToken: string): Promise<LoginResponse> {
    return this.post<LoginResponse>('/refresh', { refreshToken });
  }
